...
(d=c(".m2b-frame"),d.show(),k.show());v=d.find(".m2b-spinner");g=d.find(".m2b-image");g.hide().on("load",S).click(E);d.click(E);q=d.find(".m2b-left");r=d.find(".m2b-right");q.click(F);r.click(G);l=d.find(".m2b-title");(a.showTitle||a.showNumber)&&l.show();w=d.find(".m2b-error");w.hide();z=d.find(".m2b-btn-close");z.click(u);h=new Image;h.onload=function(){t?(m=h.naturalWidth,n=h.naturalHeight,g.attr("src",h.src).show(),H()):t=!0};h.onerror=function(){t&&(w.show(),g.hide(),v.hide(),H())};c(window).bind("resize",
...
K();v.hide()}function E(){(2>e.length||!a.showGallery)&&u()}function A(){if(a.onBeforeLoad)a.onBeforeLoad({img:g});(a.showTitle||a.showNumber)&&l.html(e[f].title).hide();g.hide();v.show();w.hide();t=!0;B=f;h.src=e[f].href}function H(){1<e.length&&(t=!1,B=1==C?M():N(),h.src=e[B].href)}function N(){var b=f-1;-1==b&&(b=e.length-1);return b}function M(){var b=f+1;b==e.length&&(b=0);return b}function F(){1<e.length&&a.showGallery&&(C=0,f=N(),A())}function G(){1<e.length&&a.showGallery&&(C=1,f=M(),A())}
...
(q.show(),r.show()):(q.hide(),r.hide());A();x=!0}function u(){k.hide();d.hide();q.unbind("click");r.unbind("click");z.unbind("click");g.unbind("load");g.unbind("click");d.unbind("click");c(window).unbind("resize",I);c(document).unbind("keyup",J);x=!1;if(a.onClose)a.onClose()}var v=null,k=null,g=null,d=null,q=null,r=null,z=null,l=null,w=null,e=[],f=0,h=null,C=1,m,n,L,x=!1,t=!0,B;if(c.isPlainObject(a))return a=c.extend({showTitle:!0,showNumber:!0,showGallery:!1,advanced:!1,onBeforeLoad:null,onLoad:null,
onResize:null,onClose:null,eventSelector:"a, img"},a),a.advanced&&(a.showGallery=!0,a.showTitle=!0,a.showNumber=!0),c(this).each(function(){var b=P(this);b&&(b.data("m2b-options",a),b.on("click",a.eventSelector,function(a){a.preventDefault();a.stopPropagation();Q(b,this)}))});var p=P(this);if(p&&"show"===a){var y="undefined"===typeof D?0:D;y=p.data("m2b-wrapper")?p.find("a").eq(y):p.eq(y);a=p.data("m2b-options");Q(p,y[0])}}})(jQuery);